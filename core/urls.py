...
urlpatterns = [
    ...
    path('genero/<str:pk>/detail/', views.GeneroDetail.as_view(), name="genero_detail"),
    ...
    path('funcionario/', views.FuncionarioList.as_view(), name="funcionario_list"),
    path('funcionario/<int:pk>/', views.FuncionarioDetail.as_view(), name="funcionario_detail"),
    path('funcionario/create/', views.FuncionarioCreate.as_view(), name='funcionario_create'),
    path('funcionario/<int:pk>/update/', views.FuncionarioUpdate.as_view(), name='funcionario_update'),
    path('funcionario/<int:pk>/delete/', views.FuncionarioDelete.as_view(), name='funcionario_delete'),
    path('export_pdf/', views.export_alugueis, name='export_alugueis')
